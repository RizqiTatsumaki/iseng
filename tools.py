...
from jon import *
#import kontol
#coded by Mr.3344 Dan Di Bantu Oleh Mr.wongedan123/Mr.w0n63dan
def pilih():
		...
		if pil == "y":
			...
			print ("\nMasukan Pilihanmu y Untuk Menu\nt Untuk Exit Tools\n");pilih()
def admin(host):
...
hem = p + """
					\033[104R Mr.3344\033[0m\033[95m
           _________                                       
         /'        /|                                      
        /         / |_                                     
       /         /  //|                                    
     ...
     |   _ _    | 8o////|                                  
     | /'// )_  |   8///|     \033[94mthanks to : Crazy Hack Team | ANON 77 Cyber\033[95m
     |/ // // ) |   8o///|    \033[94mthanks to : Zefian ganteng for banner ASCII :v\033[95m
     / // // //,|  /  8//|                                 
    / // // /// | /   8//|                                 
   / // // ///__|/    8//|                                 
  /.(_)// /// |       8///|                                
