...
def down_it(item):
	try:
		...
		print("\033[91mServer tumbang! Lucinta luna berhasil\033[0m")
...
def usage():
	...
	║  │ ││  │ │ ├─┤   ║║ ║║│ │╚═╗
	╩═╝└─┘└─┘┴ ┴ ┴ ┴  ═╩╝═╩╝└─┘╚═╝
	Pukulan Lucinta Luna Dos Script v.1
	Pembuat tidak bertanggung jawab jika digunakan untuk melawan hukum.
	Pembuat tidak bertanggung jawab jika Lucinta Luna hamil :).
...
if __name__ == '__main__':
	...
	print("\033[94mLucinta luna melakukan Pengecekan...\033[0m")
	user_agent()
	my_bots()
	time.sleep(5)
	try:
